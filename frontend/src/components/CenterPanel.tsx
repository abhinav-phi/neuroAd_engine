...
export function CenterPanel({
  ...
  const handleDrop = (e: React.DragEvent, dropIndex: number) => {
    ...
    const reindexed = newSegments.map((s, i) => ({ ...s, position: i + 1 }));
    onReorder(reindexed);
    setDragIndex(null);
    setDragOverIndex(null);
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Heatmap toggle — FIX: replaced broken <div size={11} /> with proper icon */}
        <button
        ...
        >
          {/* FIX: was <div size={11} /> which renders nothing */}
          {showHeatmap ? <List size={11} /> : <LayoutGrid size={11} />}
